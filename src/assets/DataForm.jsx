...
const DataForm = () => {
    ...
    useEffect(() => {
        axios.get('https://whimsical-kitten-77110a.netlify.app/.netlify/functions/api')
            .then((response) => {
    ...
    const handleSubmit = (e, id = null) => {
        ...
        const url = editItem
            ? `https://whimsical-kitten-77110a.netlify.app/.netlify/functions/api/${editItem._id}`
            : `https://whimsical-kitten-77110a.netlify.app/.netlify/functions/api`;
    ...
    const handleDelete = (_id) => {
        axios
            .delete(
                `https://whimsical-kitten-77110a.netlify.app/.netlify/functions/api/${_id}`
            )
            .then(() => {
